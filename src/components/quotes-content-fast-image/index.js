          ...
          <TouchableOpacity
            onPress={async () => {
              ...
              navigate('Media');
                ...
                userProfile?.data?.subscription?.audio_limit - userProfile?.data?.subscription?.audio_take != 0
              ) {
                const payload = {
                  _method: 'PATCH',
                  audio_take: 1,
                ...
                themeUser?.subscription?.audio_limit != 0 &&  userProfile?.data?.subscription?.audio_limit - userProfile?.data?.subscription?.audio_take != 0
              ) {
                const payload = {
                  _method: 'PATCH',
                  audio_take: 1,
